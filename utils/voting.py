...
if __name__ == "__main__":
    default = "JMBD4950"
    layers = ["2", "256", "512", "1024"]
    nmb_feats = [2**x for x in range(11 ,12)]
    ...
    for layer in layers:
        for x in nmb_feats:
            path_results = f"/data2/jose/projects/docClasifIbPRIA22/works_tr49_te50_perPage_LSTMvoting/work_{layer}_numFeat{x}/results.txt"
            print(path_results)
            # classes = ["p","cp","o","a","t"]
