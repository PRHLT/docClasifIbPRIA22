...
if __name__ == "__main__":
    ...
    # work_dir = f"works_JMBD4949_4950_loo_groups_trans_12clases"
    # work_dir = f"works_JMBD4949_4950_loo_groups_12classes_other"
    # work_dir = f"works_JMBD4949_4950_loo_groups_other_thresholds/works_JMBD4949_4950_loo_groups_12classes_other_0.9"
    # nmb_feats = [2**x for x in range(7,8)]
    # layers_list=["128"]
    # work_dir = "works_JMBD4949_JMBD4950_prod_12classes"
    print_as_table = True
    if print_as_table:
