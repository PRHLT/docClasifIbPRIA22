...
#ngfs=( 0 )
numfeats=$(seq 12 14 | xargs -n 1 -I {} echo "2^"{} | bc)
#res_10kwords res_10kwords_withoutNormalize res_10kwords_normRWs
path_data=work_tr49_te50_groups
# path_data=work_JMBD4949_4950_loo_1page
for try in $trys; do
    for ngf in "${ngfs[@]}"; do
        for numfeat in $numfeats; do
            python main.py --epochs 500 --work_dir works_tr49_te50_groups/work_${ngf}_numFeat${numfeat} \
