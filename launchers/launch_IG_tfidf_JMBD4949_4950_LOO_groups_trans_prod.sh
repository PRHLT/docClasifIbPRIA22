cd ..
path_resultados=work_JMBD4949_4950_loo_groups_trans_12classes_prod
mkdir ${path_resultados}
#### Information Gain
data_path=/data/carabela_segmentacion/JMBD4949_4950_idx_trans
data_path_prod=/data/carabela_segmentacion/JMBD4949_4950_idx_trans/prod
prob=0.1
...
python tf_idf_compute.py --data_path ${data_path} --prob $prob --classes $classes --path_res_train ${path_res_train} --IG_file ${path_res_IG} --path_res_classes ${path_res_classes} --path_res_prod ${path_res_prod} --prod true --data_path_prod ${data_path_prod}
cd launchers