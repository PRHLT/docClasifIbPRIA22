...
python tf_idf_compute.py --data_path ${data_path} --prob $prob --classes $classes --path_res_train ${path_res_train} --IG_file ${path_res_IG} --path_res_classes ${path_res_classes} --path_res_test ${path_res_test} --data_path_te ${data_path_te} --path_res_prod ${path_res_prod} --data_path_prod ${data_path_prod} --all_files True
cd launchers
