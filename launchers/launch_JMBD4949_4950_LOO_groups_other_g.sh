...
#ngfs=( 0 )
numfeats=$(seq 11 12 | xargs -n 1 -I {} echo "2^"{} | bc)
#res_10kwords res_10kwords_withoutNormalize res_10kwords_normRWs
path=work_JMBD4949_4950_loo_groups_other_g
for try in $trys; do
    for ngf in "${ngfs[@]}"; do
        for numfeat in $numfeats; do
            python main.py --epochs 500 --work_dir works_JMBD4949_4950_loo_groups_12classes_other_g/work_${ngf}_numFeat${numfeat} \
