...
path=work_JMBD4949_4950_loo_1page_other
path_file_groups=${path}/groups
for try in $trys; do
    for ngf in "${ngfs[@]}"; do
        for numfeat in $numfeats; do
            python main.py --epochs 500 --work_dir works_JMBD4949_4950_loo_1page/work_${ngf}_numFeat${numfeat} \
